                ...
                <div className="lg:col-span-1 space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                <span className="text-2xl font-extrabold text-gray-900">
                                    {Number(therapist.average_rating || 0).toFixed(1)}
                                </span>
                                <div className="flex text-amber-400">
                                    <Star className="w-4 h-4 fill-current" />
                                </div>
                            </div>
                            <p className="text-xs font-bold text-gray-400 mt-1">{therapist.reviews_count || 0} Reviews</p>
                        </div>

                        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Est. Revenue</p>
                            <div className="flex items-center gap-1 mt-1 font-extrabold text-gray-900 text-2xl">
                                <IndianRupee className="w-5 h-5 text-gray-400" />
                                {Number(therapist.total_revenue || 0).toLocaleString()}
                            </div>
                            <p className="text-xs font-bold text-gray-400 mt-1">{bookings.length} Total Bookings</p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                            ...
                            <p className="text-xs font-bold text-gray-400 mt-1">Patients</p>
                        </div>

                        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Service Hours</p>
                            <p className="text-2xl font-extrabold text-gray-900 mt-1">
                                {Math.round((Number(therapist.total_service_minutes || 0) / 60) * 10) / 10}
                            </p>
                            <p className="text-xs font-bold text-gray-400 mt-1">Hours Delivered</p>
                        </div>
                    </div>
                </div>
